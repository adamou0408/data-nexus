...
- **下一動作:Tier A roadmap §2.1 排序第 #3 = feedback** — sub-plan 待寫 (next session)；reuse SAVED-VIEW-V01 pattern (per-user state table + 6-route CRUD + JSONB-only avoid)；#1 default-perm pilot 已獨立 IN-PROGRESS plan
