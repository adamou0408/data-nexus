...
>
> 本文件的「通用型系統設計平台」定位已於 2026-04-22 會議中被判定為**誤導方向**。
> Phase 1 實際方向為 **BI + AI**（Tier 1/2/3 BI 產品線 + AI 助理 + Path A 辦死），
> 請見 **`docs/plan-v3-phase-1.md`** 為當前 SSOT。
>
> 本文件保留作為「通用平台願景」的遠景參考，Phase 2 規劃時再評估是否重寫或正式 retire。
